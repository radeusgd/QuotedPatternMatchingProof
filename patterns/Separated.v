...
| App (e1 e2 : typedterm)
| Lift (e: typedterm)
| PatNat (e : typedterm) (n : nat) (s f : typedterm)
| PatBindVar (e : typedterm) (T : type) (s f : typedterm)
| PatBindApp (e : typedterm) (T1 T2 : type) (s f : typedterm)
| PatBindLam (e : typedterm) (T : type) (s f : typedterm)
.
...
with traverse_term f l u :=
  ...
  | PatNat e N success failure =>
    PatNat (traverse_typedterm f l e) N (traverse_typedterm f (l) success) (traverse_typedterm f l failure)
  | PatBindVar e T success failure =>
    PatBindVar (traverse_typedterm f l e) T (traverse_typedterm f (1 + l) success) (traverse_typedterm f l failure)
  | PatBindApp e T1 T2 success failure =>
    PatBindApp (traverse_typedterm f l e) T1 T2 (traverse_typedterm f (2 + l) success) (traverse_typedterm f l failure)
  | PatBindLam e T success failure =>
    PatBindLam (traverse_typedterm f l e) T (traverse_typedterm f (1 + l) success) (traverse_typedterm f l failure)
  end.
