...
{ t_1 \longrightarrow^0 t_1'}
{ \tpd{(\texttt{MatchNat} \; t_1 \; n \; t_2 \; t_3)}{T} \longrightarrow^0 \tpd{(\texttt{MatchNat} \; t_1' \; n \; t_2 \; t_3)}{T} }
\vspace{1mm}
...
{ t_1 \longrightarrow^0 t_1'}
{ \tpd{(\texttt{MatchVar} \; t_1 \; x \; t_2 \; t_3)}{T} \longrightarrow^0 \tpd{(\texttt{MatchVar} \; t_1' \; x \; t_2 \; t_3)}{T} }

\vspace{1mm}

\infrule[E-PatApp-Red]
{ t_1 \longrightarrow^0 t_1'}
{ \tpd{(\texttt{MatchApp} \; t_1 \; T_1 \; T_2 \; b_0 \; b_1 \; t_2 \; t_3)}{T} \longrightarrow^0 \tpd{(\texttt{MatchApp} \; t_1' \; T_1 \; T_2 \; b_0 \; b_1 \; t_2 \; t_3)}{T} }

\vspace{1mm}

\infrule[E-PatUnlift-Red]
{ t_1 \longrightarrow^0 t_1'}
{ \tpd{(\texttt{MatchUnlift} \; t_1 \; b_0 \; t_2 \; t_3)}{T} \longrightarrow^0 \tpd{(\texttt{MatchUnlift} \; t_1' \; b_0 \; t_2 \; t_3)}{T} }

\vspace{1mm}

\infrule[E-PatLam-Red]
{ t_1 \longrightarrow^0 t_1'}
{ \tpd{(\texttt{MatchLam} \; t_1 \; (T_1 \to T_2) \; b_0 \; t_2 \; t_3)}{T} \longrightarrow^0 \tpd{(\texttt{MatchLam} \; t_1' \; (T_1 \to T_2) \; b_0 \; t_2 \; t_3)}{T} }

\vspace{1mm}

\infrule[E-Pat-Fail]
{ TODO }
{ \tpd{(\texttt{MatchNat} \; t_1 \; n \; t_2 \; t_3)}{T} \longrightarrow^0 t_2 }
